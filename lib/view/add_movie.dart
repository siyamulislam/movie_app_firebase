...
class _Add_MovieState extends State<Add_Movie> {
                ...
                child: ListView(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                            onPressed: _pickDate, child: Text("Select Date")),
                        Text(dt == null
                            ? "dd/mm/yyyy"
                            : dt!.day.toString() +
                                '/' +
  ...
  _saveData() async {
    if (_formKey.currentState!.validate()) {
      ...
      Reference photoRef =
          rootRef.child('MoviesIMG/${DateTime.now().millisecondsSinceEpoch}');
      final UploadTask uploadTask = photoRef.putFile(File(_imagePath!));
      ...
      // print(movie);
      DBFirebaseHelper.insertMovie(movie).then((_) {
        //if(value>0){
